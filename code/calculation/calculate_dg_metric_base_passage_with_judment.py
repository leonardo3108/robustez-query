...
nDCG10_original = df_calculated_metric.query('cod_metric == "nDCG@10" and cod_noise_kind == 0 and language == "pt"').set_index(['cod_original_query', 'language', 'cod_search_context'])[['value']].to_dict()['value']
...
df_dg = df_calculated_metric.query('cod_metric == "nDCG@10" and cod_noise_kind != 0 and language == "pt"')[['cod_original_query','cod_noise_kind','cod_search_context','value','qtd_judment_assumed_zero_relevance','language']]
